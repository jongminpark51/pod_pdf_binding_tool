...
비밀번호를 알고 있는 PDF는 `원본 PDF 열람 비밀번호`에 해당 비밀번호를 입력하면 처리할 수 있습니다. 비밀번호 없이 열리는 암호화 PDF는 자동으로 열람을 시도합니다.
...
생성된 `dist/pdf_binding_sample_tool_v1.1.1.zip` 파일을 GitHub Release에 첨부하면 운영자가 ZIP을 내려받아 사용할 수 있습니다.
